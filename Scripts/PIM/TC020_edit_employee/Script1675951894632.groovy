...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/button_Odis Adalwin_oxd-icon-button oxd-tab_b0d3c8'))

WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_Employee Full Name_firstName'), 'Aliya')
