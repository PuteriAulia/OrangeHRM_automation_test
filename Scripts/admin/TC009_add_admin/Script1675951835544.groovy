...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/div_User RoleESSEmployee NameStatusDisabled_070740'))

WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_Username_oxd-input oxd-input--focus o_d4f516'), 'admin123')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_OrangeHRM/input_Password_oxd-input oxd-input--focus o_671073'), 
    '/5S6MFFLcE4ValVRLQoE0w==')
